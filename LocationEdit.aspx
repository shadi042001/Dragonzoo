<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LocationEdit.aspx.cs" Inherits="job.LocationEdit" %>
            ...
            <form class="form-horizontal" id="form1" runat="server">
                ...
                <div class="form-group">        
                    <div class="col-sm-offset-2 col-sm-10">
                        ...
                        <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Update Location" />
